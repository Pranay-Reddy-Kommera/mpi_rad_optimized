...
! KGEN version: 0.5.1
    ...
    MODULE rrsw_kg21
        ...
        ! sfluxref: real
        !-----------------------------------------------------------------
        REAL(KIND=r8) :: absa(585,ng21)
        REAL(KIND=r8) :: absb(1175,ng21)
        REAL(KIND=r8) :: forref(4,ng21)
        REAL(KIND=r8) :: selfref(10,ng21)
        REAL(KIND=r8) :: sfluxref(ng21,9)
        PUBLIC kgen_read_externs_rrsw_kg21
    CONTAINS
    ...
    SUBROUTINE kgen_read_externs_rrsw_kg21(kgen_unit)
    ...
    END SUBROUTINE kgen_read_externs_rrsw_kg21
