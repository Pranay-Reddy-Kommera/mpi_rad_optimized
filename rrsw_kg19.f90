...
! KGEN version: 0.5.1
    ...
    MODULE rrsw_kg19
        ...
        ! sfluxref: real
        !-----------------------------------------------------------------
        REAL(KIND=r8) :: absa(585,ng19)
        REAL(KIND=r8) :: absb(235,ng19)
        REAL(KIND=r8) :: selfref(10,ng19)
        REAL(KIND=r8) :: forref(3,ng19)
        REAL(KIND=r8) :: sfluxref(ng19,9)
        PUBLIC kgen_read_externs_rrsw_kg19
    CONTAINS
    ...
    SUBROUTINE kgen_read_externs_rrsw_kg19(kgen_unit)
    ...
    END SUBROUTINE kgen_read_externs_rrsw_kg19
